...
1. 確保已安裝相關依賴：`pip install opencv-python ultralytics torch requests ffmpeg-python pytz`
2. 配置 RTSP 攝影機地址。
3. 執行對應站點的指令碼，例如：`python DES_temporarily_backup.py`

---
*本專案為個人 Side Project，持續更新中。*
